...
# Source module: operators/sampling/rnd.py
...
class PermutationRandomSampling(Sampling):
    ...
    def _do(self, problem, n_samples, *args, random_state=None, **kwargs):
        ...
        return X
FloatRandomSampling_JAX = FloatRandomSampling
BinaryRandomSampling_JAX = BinaryRandomSampling
IntegerRandomSampling_JAX = IntegerRandomSampling
PermutationRandomSampling_JAX = PermutationRandomSampling
