...
from core.survival import Survival, split_by_feasibility
from operators.survival.rank_and_crowding.metrics import get_crowding_function
from util.nds.non_dominated_sorting import NonDominatedSorting
from util.randomized_argsort import randomized_argsort
...
class RankAndCrowding(Survival):
    ...
    def __init__(self, nds=None, crowding_func="cd"):
        ...
        nds : str or None, optional
            EmoPyLab type of non-dominated sorting. Defaults to None.
