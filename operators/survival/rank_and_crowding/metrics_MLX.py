...
# Generated by tools/generate_mlx_variants.py
...
def _calc_mnn_fast(F, n_neighbors, **kwargs):
    ...
    d[_extremes] = np.inf
    return d
CrowdingDiversity_MLX = CrowdingDiversity
FunctionalDiversity_MLX = FunctionalDiversity
FuncionalDiversityMNN_MLX = FuncionalDiversityMNN
