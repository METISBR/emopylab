...
"""
MW constrained multi-objective benchmark family.
...
from util.ref_dirs import get_ref_dirs
...
class MW5(_MW):
    ...
    def _calc_pareto_front(self, **kwargs):
        return Remote.get_instance().load("emopylab", "pf", "MW", "MW5.pf")
...
class MW7(_MW):
    ...
    def _calc_pareto_front(self, **kwargs):
        return Remote.get_instance().load("emopylab", "pf", "MW", "MW7.pf")
...
class MW9(_MW):
    ...
    def _calc_pareto_front(self, **kwargs):
        return Remote.get_instance().load("emopylab", "pf", "MW", "MW9.pf")
...
class MW10(_MW):
    ...
    def _calc_pareto_front(self, **kwargs):
        return Remote.get_instance().load("emopylab", "pf", "MW", "MW10.pf")
...
class MW11(_MW):
    ...
    def _calc_pareto_front(self, **kwargs):
        return Remote.get_instance().load("emopylab", "pf", "MW", "MW11.pf")
...
class MW13(_MW):
    ...
    def _calc_pareto_front(self, **kwargs):
        return Remote.get_instance().load("emopylab", "pf", "MW", "MW13.pf")
...
class MW14(_MW):
    ...
    def _calc_pareto_front(self, **kwargs):
        if self.n_obj == 3:
            return Remote.get_instance().load("emopylab", "pf", "MW", "MW14.pf")

_CPU = ["MW1", "MW2", "MW3", "MW4", "MW5", "MW6", "MW7", "MW8", "MW9", "MW10", "MW11", "MW12", "MW13", "MW14"]
for _name in _CPU:
    _base = globals()[_name]
